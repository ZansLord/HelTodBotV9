...
*࿊⃟🕊️* ${prefix}suit *batu/kertas/gunting*
`
}
...
*࿊⃟🕊️* ${prefix}togel
*࿊⃟🕊️* ${prefix}cekwatak
*࿊⃟🕊️* ${prefix}cekmati [nama]
*࿊⃟🕊️* ${prefix}wangy [nama]
*࿊⃟🕊️* ${prefix}citacita
*࿊⃟🕊️* ${prefix}toxic
*࿊⃟🕊️* ${prefix}truth
*࿊⃟🕊️* ${prefix}dare
...
*࿊⃟🕊️* ${prefix}beban
*࿊⃟🕊️* ${prefix}babi
*࿊⃟🕊️* ${prefix}cekganteng
*࿊⃟🕊️* ${prefix}cekcantik
...
*࿊⃟🕊️* ${prefix}brainly *query*
*࿊⃟🕊️* ${prefix}shopee *product*
*࿊⃟🕊️* ${prefix}playstore *query*
*࿊⃟🕊️* ${prefix}ssweb *query*
*࿊⃟🕊️* ${prefix}google *query*
*࿊⃟🕊️* ${prefix}image *query*
*࿊⃟🕊️* ${prefix}pinterest *query*
*࿊⃟🕊️* ${prefix}nulis *teks*
*࿊⃟🕊️* ${prefix}iguser *ussername*
*࿊⃟🕊️* ${prefix}igstalk *username*
*࿊⃟🕊️* ${prefix}githubstalk *username*
*࿊⃟🕊️* ${prefix}tiktokstalk *ussername*
*࿊⃟🕊️* ${prefix}img2url *reply foto*
*࿊⃟🕊️* ${prefix}ytsearch *query*
...
*࿊⃟🕊️* ${prefix}garwgura
*࿊⃟🕊️* ${prefix}ttg *teks*
*࿊⃟🕊️* ${prefix}attp *teks*
*࿊⃟🕊️* ${prefix}stickeranime
*࿊⃟🕊️* ${prefix}semoji *emoji*
*࿊⃟🕊️* ${prefix}sticker *reply foto/video*
*࿊⃟🕊️* ${prefix}smeme *teks|teks*
*࿊⃟🕊️* ${prefix}swm *pack|author*
*࿊⃟🕊️* ${prefix}take *pack|author* 
*࿊⃟🕊️* ${prefix}tovideo *reply sgif*
...
*࿊⃟🕊️* ${prefix}clearall
*࿊⃟🕊️* ${prefix}leaveall
*࿊⃟🕊️* ${prefix}join *link gc*
*࿊⃟🕊️* ${prefix}shutdown
*࿊⃟🕊️* ${prefix}getquoted
*࿊⃟🕊️* ${prefix}addupdate *fiturnya*
*࿊⃟🕊️* ${prefix}exif *nama|author*
*࿊⃟🕊️* ${prefix}sewa add/del *waktunya*
*࿊⃟🕊️* ${prefix}premium add @tag|nomor
*࿊⃟🕊️* ${prefix}premium del @tag|nomor
...
*࿊⃟🕊️* ${prefix}groupsetting
*࿊⃟🕊️* ${prefix}afk *alasan*
*࿊⃟🕊️* ${prefix}ceksewa
*࿊⃟🕊️* ${prefix}kickall
*࿊⃟🕊️* ${prefix}infogrup
*࿊⃟🕊️* ${prefix}promote
...
*࿊⃟🕊️* ${prefix}tagall *teks*
*࿊⃟🕊️* ${prefix}leave
*࿊⃟🕊️* ${prefix}kick *reply*
*࿊⃟🕊️* ${prefix}add *+62xxxxxx*
*࿊⃟🕊️* ${prefix}setgrupname
*࿊⃟🕊️* ${prefix}setppgrup
*࿊⃟🕊️* ${prefix}setdesc
*࿊⃟🕊️* ${prefix}sider *reply chat bot*
*࿊⃟🕊️* ${prefix}hidetag *teks/reply teks*
,
`
}
...
*࿊⃟🕊️* ${prefix}tiktokaudio
*࿊⃟🕊️* ${prefix}mediafire 
*࿊⃟🕊️* ${prefix}nhentaipdf *code*
...
*࿊⃟🕊️* ${prefix}sourcecode
*࿊⃟🕊️* ${prefix}bugreport *keluhan*
