...
const isImage = (type === 'imageMessage')
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
        ...
        ////DAFTAR BUTTON 
      const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan Bot 𝐇𝐄𝐋𝐆𝐀 𝐙𝐄𝐗 Verify Terlebih Dahulu Ya `
...
switch (command) {
	case '%':
              ...
              reply('Otw Kudeta')
                tessgc = await getBuffer(`https://e.top4top.io/p_21336v4de1.jpg`)
...
if (args.length < 2) return reply(`Penggunaan ${command} idgroup`)
        ...
        case 'creator':
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: ' ```BOT CREATED BY HELGA``` ',
               buttons: buttons,
               headerType: 1
}
...
*NOMOR CREATOR*
▼▼▼▼▼`)
sendKontak(from, `6282138919347`, `${ownerName}`, 'Sibukk!!')
               await sleep(1000)
               break
               case 'spamcall':{
...
*࿊⃟🌸𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌* :
*https://instagram.com/helga_store20*      
*࿊⃟🌸𝐓𝐈𝐊𝐓𝐎𝐊* :
...
ILHAM BOT merupakan project bot WhatsApp yang menggunakan Vps Atau Rdp, dijalankan menggunakan engine nodejs v14.0.0
...
▷ *࿊⃟𝐇結* 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡??𝐭𝐬 : *${privat.length}*
▷ *࿊⃟𝐇結* 𝐓????𝐚𝐥 𝐂𝐡𝐚??𝐬 : *${totalChat.length}*
▷ *࿊⃟𝐇結* 𝐒𝐩𝐞𝐞𝐝 : *${latensie.toFixed(4)} _Second_*
▷ *࿊⃟𝐇結* 𝐀??𝐭𝐢𝐯𝐞 : *${runtime(process.uptime())}*
▷ *࿊⃟𝐇結* 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : *${os.platform()}*
...
*࿊⃟📚結* ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created 𝑰𝒍𝒉𝒂𝒎 𝑩𝒐𝒕𝒛🌠`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
                   sendButMessage(from, wibu, `𝐇𝐄𝐋𝐆𝐀 𝐙𝐄𝐗`, [
          {
            buttonId: `!menu`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
`
        ...
        case 'wasted':
		      ...
		      buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Follow @helga_store20`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'𝑰𝒍𝒉𝒂𝒎 𝑩𝒐𝒕𝒛🌠', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @helga_store20`,buttons,headerType:4}
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                  ...
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${setting.lolkey}&text=${ini_txt}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'𝑰𝒍𝒉𝒂𝒎 𝑩𝒐𝒕𝒛🌠T', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @helga_store20`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
...
Made With ❤️ 𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝑩𝒚 ٬࿊⃟𝑯𝒆𝒍𝒈𝒂𝒂 𝒁𝒆𝒙'𝒔シ︎
...
*࿊⃟𝐇結* 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : *${groups.length}*
*࿊⃟𝐇結* 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡??𝐭𝐬 : *${privat.length}*
*࿊⃟𝐇結* 𝐓𝐨??𝐚?? 𝐂𝐡𝐚𝐭𝐬 : *${totalChat.length}*
*࿊⃟𝐇結* 𝐒𝐩𝐞??𝐝 : *${latensie.toFixed(4)} _Second_*
*࿊⃟𝐇結* 𝐀𝐜𝐭𝐢𝐯?? : *${runtime(process.uptime())}*
*࿊⃟𝐇結* 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : *${os.platform()}*
...
`
 ...
 𝑰𝒍𝒉𝒂𝒎 𝑩𝒐𝒕𝒛🌠︎`, imageMessage: imageMsg,
   ...
   case 'command':
               ...
               const yy = {title: 'Helga Menu' + nombor++,
                    rows: [
                       {
...
*『 𝑰𝒍𝒉𝒂𝒎 𝑩𝒐𝒕𝒛🌠︎ 』*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Thank you for late registration 𝑰𝒍𝒉𝒂𝒎 𝑩𝒐𝒕𝒛🌠*`)
		}, 2000)
        break
case 'tos':
...
ILHAM BOT merupakan project bot WhatsApp yang menggunakan termux, dijalankan menggunakan engine nodejs v14.0.0
...
Owner: Helga Zex | wa.me/6282138919347`
...
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `𝐎𝐖𝐍𝐄𝐑👑`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `𝐏𝐀𝐘𝐌𝐄𝐍𝐓`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:' ```BOT CREATED BY HELGA``` ', imageMessage: imageMsg,
              contentText: teksnya,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
              break
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             sendMess(_.jid, `*『 Helga Broadcast 💫 』*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
ikyy.sendMessage(_.jid, 
			{"contentText": `*『 Helga Broadcast 💫 』*\n\n${body.slice(4)}`,
			"footerText": '𝐈𝐥𝐡𝐚𝐦 𝐁𝐨𝐭𝐳💫',
			"buttons": [
			{"buttonId": `#command`,
...
//------------------< Fun >-------------------
      ...
      break
       ...
       case 'truth':
              ...
              truteh = await getBuffer(`https://e.top4top.io/p_21336v4de1.jpg`)
       ...
       case 'dare':
              ...
              buff = await getBuffer(`https://e.top4top.io/p_21336v4de1.jpg`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Donasi Ya Kak 🌠', imageMessage: imageMsg,
...
//------------------< Lainnya >-------------------
        case 'getpp':
               if (kyy.message.extendedTextMessage === null || kyy.message.extendedTextMessage === undefined) {
               linkpp = await ikyy.getProfilePicture(from) || "https://e.top4top.io/p_21336v4de1.jpg"
               ...
               linkpp = await ikyy.getProfilePicture(mberr) || "https://e.top4top.io/p_21336v4de1.jpg"
               buffer = await getBuffer(linkpp)
        ...
        case 'info':  // Jangan Di Ubah Plise
               urlinfo = 'https://e.top4top.io/p_21336v4de1.jpg'
